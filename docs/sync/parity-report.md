...
**Generated:** `2026-08-27T01:51:25.381649+00:00`  
**Upstream Baseline:** `59f96e3`  
**Upstream HEAD:** `cecce1c`  
**Parity Percentage:** `96.7%`  
...
| `8b9688d` | backend/api, frontend/inspector, other, pricing/engine | fix(grok): read billed usage from the unified inference log | `internal/scanner/parsers/grok.go`, `internal/pricing/engine.go` |
